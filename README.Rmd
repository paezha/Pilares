...
Compare to [Espacio Escultural](https://www.atlasobscura.com/places/espacio-escultorico) in Mexico City, with its awe-inspiring monumental scale.
...
Package [{rayrender}](https://www.rayrender.net/index.html) makes it surprisingly easy to to this. Most of the work goes into finding parameters that create pleasing perpsectives. At the moment, I experiment with two colonnades, but it would be interesting to create "gardens" of pillars with other arrangments, such as spirals, etc.
...
# Display image
knitr::include_graphics(glue("outputs/pilares-{seed}.png"))
```
